      ...
      <main>
        ...
        <section className="inquiry-block reveal reveal-5" id="inquiry">
          <div className="section-heading">
            ...
            <h2>Tell Us Your Requirement And We Route It To Admin.</h2>
            <p className="section-intro">
              This form uses your Spring Boot API to store inquiries in PostgreSQL and route
              email details directly to admin.
            </p>
          </div>
